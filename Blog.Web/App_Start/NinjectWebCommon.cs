...
namespace Blog.Web.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            System.Web.Http.GlobalConfiguration.Configuration.DependencyResolver = new Blog.Web.NinjectResolv.NinjectDependencyResolver(kernel);
            DependencyResolver.SetResolver(new Blog.Web.NinjectResolv.MVCDependencyResolver(kernel));
        }
    }
}
